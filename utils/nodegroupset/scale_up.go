...
// 	return fmt.Sprintf("{Cluster %v->%v (max: %v)}", s.CurrentSize, s.NewSize, s.MaxSize)
// }
...
// func BalanceScaleUpBetweenGroups(groups []cloudprovider.NodeGroup, newNodes int) ([]ScaleUpInfo, errors.AutorepairError) {
// 	if len(groups) == 0 {
// 		return []ScaleUpInfo{}, errors.NewAutorepairError(
